export default function BoardUsersPage() {
  return (
    <div className="flex-1 overflow-y-auto p-6" style={{ backgroundColor: 'var(--background)' }}>
      <div className="mb-6">
        <h1 style={{ color: 'var(--foreground)', fontSize: '1.25rem', fontWeight: 700 }}>Board Users</h1>
        <p style={{ color: 'var(--muted-foreground)', fontSize: '0.83rem', marginTop: 4 }}>
          Manage owners, dispatchers, and updaters across all companies.
        </p>
      </div>
      <div
      ...
      >
        <p style={{ color: 'var(--muted-foreground)', fontSize: '0.9rem' }}>Board Users table coming soon.</p>
      </div>
    </div>
  );
}
